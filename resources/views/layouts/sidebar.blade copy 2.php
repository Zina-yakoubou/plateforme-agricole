<aside class="w-72 min-h-screen bg-white border-r border-slate-200 flex flex-col relative">
...
<details open
class="border border-slate-200 rounded-xl mb-3">


<summary
class="cursor-pointer flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-green-50">
...
{{-- Pour l'instant utilise les mêmes routes disponibles --}}
...
<div class="w-11 h-11 rounded-full bg-green-600 
